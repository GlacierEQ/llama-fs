...
async def batch(request: Request):
    ...
    **Responses**:
    ...
    """
    # Validate that the provided path is safe and sanitized.
    if not request.path or not (is_safe_path(request.path) and sanitize_path(request.path)):
...
async def commit(request: CommitRequest):
    ...
    **Responses**:
    ...
    # Ensure both src and dst are safe and sanitized.
